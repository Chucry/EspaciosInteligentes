...
namespace EspaciosInteligentes.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,LastName,BirthDate,Email,Password,Phone,Mobile,Department,Role,HireDate,TerminationDate,BaseSalary,Address,Address2,SSN,CURP,CLABE")] Employee employee)
        {
