...
namespace EspaciosInteligentes.Views.PromoCodes
{
    public class PromoCodesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Code,Amount,Description,ExpirationDate,CreatedDate,Type")] PromoCode promoCode)
        {
